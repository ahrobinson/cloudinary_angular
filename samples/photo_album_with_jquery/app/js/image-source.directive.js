...
var CloudinaryImageSourceDirective = (function () {
    function CloudinaryImageSourceDirective(el) {
        this.el = el;
    }
    CloudinaryImageSourceDirective.prototype.getAttributes = function () {
        return this.el.nativeElement.attributes;
    };
    CloudinaryImageSourceDirective = __decorate([
        core_1.Directive({
            selector: '[cl-src],[cl-srcset],[cl-href]'
        }), 
...
//# sourceMappingURL=image-source.directive.js.map